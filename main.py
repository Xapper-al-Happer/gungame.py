...
while True:
    ...
    try:
        ...
        print("\nThe port you entered was not a number ya hmar, try again with a correct port...")
        continue
    ...
    try:
        ...
        print("\nThe IP address you entered is invalid ya hmar, please try again with a correct address...")
        error_occurred = True
    finally:
        n.settimeout(None)
...
ursina.window.title = "Best fps game 1999"
